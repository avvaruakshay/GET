...
const getParent = function(level){
    let parent;
    if (level == 'Kingdom' || level == 'Group'){parent = 'Kingdom'}
    else if (level == 'SubGroup'){parent = 'Group'}
    else if (level == 'Organism'){parent = 'SubGroup'}
    return parent;
}

const getSubLevel = function(level){
    let sublevel;
    if (level == 'GOD'){sublevel = 'Kingdom'}
    else if (level == 'Kingdom'){sublevel = 'Group';}
    else if (level == 'Group'){sublevel = 'SubGroup';}
    else if (level == 'SubGroup'){sublevel = 'Organism';}
    return sublevel;
}
...
const get_maxcod = function(ymax){
  ...
  else if (ymax <= 100){ymax = (Math.ceil(ymax/10))*10 + 30;}
  else if (ymax <= 1000){ymax = (Math.ceil(ymax/100))*100 + 100;}
  else if (ymax <= 10000){ymax = (Math.ceil(ymax/100))*100 + 500;}
  else if (ymax <= 100000){ymax = (Math.ceil(ymax/1000))*1000 + 1000;}
  else if (100000 < ymax){ymax = ((Math.ceil(ymax/10000))*10000) + 5000;}
  return ymax;
